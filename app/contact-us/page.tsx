  ...
  return (
    <div className="flex flex-col min-h-screen">
      <main className="flex-1">
        <section className="w-full py-8 md:py-12 bg-gradient-to-b from-purple-50 to-white">
              ...
              <div>
                <div className="flex flex-col items-center md:items-start mb-6">
                  <div className="mb-4 rounded-full bg-purple-100 p-2">
                    <img
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/486107709_3887888471484424_801691660998076096_n-amI8Ls76ovs18edRTltmlESmL2Ahhy.png"
                      alt="Daisy Mae Reyes Bongtiwon"
                      className="h-24 w-24 rounded-full object-cover"
                    />
                  </div>
                  <h2 className="text-xl font-bold">Daisy Mae Reyes Bongtiwon</h2>
        ...
        <section className="w-full py-8 bg-purple-50">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
              ...
              <div className="w-full max-w-3xl space-y-3">
                <Card>
                  <CardHeader className="py-3">
                    <CardTitle className="text-base">How do I get started with the learning modules?</CardTitle>
                  </CardHeader>
                ...
                <Card>
                  <CardHeader className="py-3">
                    <CardTitle className="text-base">Are the resources free to access?</CardTitle>
                  </CardHeader>
                  <CardContent className="pt-0">
                    <p className="text-sm text-muted-foreground">
                ...
                <Card>
                  <CardHeader className="py-3">
                    <CardTitle className="text-base">Can I switch between different career paths?</CardTitle>
                  </CardHeader>
                  <CardContent className="pt-0">
                    <p className="text-sm text-muted-foreground">
